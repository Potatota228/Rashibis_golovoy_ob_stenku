...
// ============================================================
// ИНТЕРАКТИВНОЕ МЕНЮ ДЛЯ РАБОТЫ С ФАЙЛОМ
// ============================================================

void interactiveFileMenu() {
    cout << "\n--- Подготовка тестового файла ---" << endl;
    ...
    cout << "\nСоздание хеш-таблицы из файла..." << endl;
    ...
    while (running) {
        cout << "\n╔════════════════════════════════════════════════╗" << endl;
        cout << "║   ИНТЕРАКТИВНАЯ РАБОТА С ХЕЭ-ТАБЛИЦЕЙ          ║" << endl;
        cout << "╚════════════════════════════════════════════════╝" << endl;
        cout << "\n1. Показать все книги" << endl;
        cout << "2. Показать хеш-таблицу" << endl;
        cout << "3. Найти книгу по ISBN" << endl;
        cout << "4. Добавить новую книгу" << endl;
        cout << "5. Удалить книгу по ISBN" << endl;
        cout << "6. Сравнить производительность поиска" << endl;
        cout << "7. Создать большой тестовый файл" << endl;
        ...
        switch (choice) {
            ...
            case 3: {
                cout << "\nВведите ISBN для поиска: ";
                long long isbn;
                cin >> isbn;
                cin.ignore();
                
                Book book;
                cout << "\nПоиск через хеш-таблицу..." << endl;
            ...
            case 4: {
                ...
                if (addBookWithHash(ht, newBook)) {
                    ...
                    cout << "\n✗ Ошибка при добавлении книги" << endl;
                }
                break;
            }
            
            case 5: {
                cout << "\nВведите ISBN для удаления: ";
                long long isbn;
                cin >> isbn;
                cin.ignore();
                ...
                if (deleteBookByISBN(ht, isbn)) {
                    ...
                    cout << "\n✗ Ошибка при удалении книги" << endl;
                }
                break;
            }
...
void testStringSearch() {
    ...
    string text3 = "В магазине: ноутбук HP за $1,299.99, "
                   ...
                   "ноутбук Asus стоит 65,000 руб.";
    findPricesInText(text3, "ноутбук Asus", true);
...
void showMenu() {
    ...
    cout << "1. ПР 6.1 - Интерактивная работа с хеш-таблицей" << endl;
    cout << "   • Добавление/удаление книг" << endl;
    cout << "   • Поиск по ISBN" << endl;
    cout << "   • Просмотр таблицы" << endl;
    
    cout << "\n2. ПР 6.1 - Комплексное автоматическое тестирование" << endl;
    cout << "   • Все операции с хеш-таблицей" << endl;
    cout << "   • Рехеширование" << endl;
    cout << "   • Сравнение производительности" << endl;
    
    cout << "\n3. ПР 6.2 - Поиск в тексте" << endl;
